    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://mollusklike-intactly-kennedi.ngrok-free.dev/api/labs/login",
                {
                    email: email,
                    password: password,
                },
            ...
            if (response.data.success) {
                ...
                if (role === "admin" && realLevel === "adminops") {
                    setErrorMsg(
                        "Akses Ditolak. Akun Anda terdaftar sebagai Lab Teknisi, silakan masuk melalui portal Lab.",
                    );
                    setLoading(false);
                ...
                if (role === "labs" && realLevel !== "adminops") {
                    setErrorMsg(
                        "Akses Ditolak. Akun Anda bukan bagian dari Lab Teknisi.",
                    );
                    setLoading(false);
                    return;
                }
                ...
                <div className="relative z-10 max-w-xl text-white">
                    <div className="mb-10 inline-flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-full backdrop-blur-md">
                        ...
                        <span className="text-blue-100 text-sm font-medium">
                            AI-Powered Eye Diagnostics v2.4
                        </span>
                    </div>
                    ...
                    <p className="text-lg text-slate-400 mb-12">
                        Verifikasi identitas Anda untuk mengakses database
                        pasien dan hasil analisis AI GlaucoScan.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-[45%] flex items-center justify-center p-6 bg-white">
                <div className="w-full max-w-md">
                    <div className="mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-slate-900 mb-2 italic">
                            GlaucoScan
                        </h2>
                        <p className="text-slate-500 font-medium">
                            Gerbang Akses Portal Medis.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col items-center gap-4 text-center">
                        ...
                        <p className="text-[10px] text-slate-400 font-bold italic">
                            © 2026 Divisi IT RS Mata Sejahtera Lamongan.
                        </p>
                    </div>
                </div>
            </div>
