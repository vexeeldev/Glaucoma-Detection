                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <h3 className="text-3xl font-black text-gray-800 tracking-tight">
                                EfficientNetB4{" "}
                                <span className="text-purple-600">v2.1.0</span>
                            </h3>
                            <Badge variant="active">AKTIF</Badge>
                        </div>
                        <p className="text-gray-500 font-medium">
                            Model produksi utama untuk deteksi glaukoma
                            otomatis.
                        </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <h3 className="text-lg font-bold mb-4">
                        Informasi Training Terakhir
                    </h3>
                    <div className="space-y-4">
                        {[
                            {
                                label: "Total Dataset Training",
                                value: "12,450 Citra",
                            },
