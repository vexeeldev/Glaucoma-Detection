...
const UserPage = () => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            const response = await axios.get(
                "https://mollusklike-intactly-kennedi.ngrok-free.dev/api/labs/management/users",
                {
                    params: {
                        search,
                        role,
    ...
    const handleToggleStatus = async (id) => {
        try {
            await axios.patch(
                `https://mollusklike-intactly-kennedi.ngrok-free.dev/api/labs/management/users/${id}/status`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(
                `https://mollusklike-intactly-kennedi.ngrok-free.dev/api/labs/management/users/${id}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                        Accept: "application/json",
                            ...
                            users.map((user, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <Badge
                                            variant={`role_${user.role.toLowerCase()}`}
                                        >
                                            {user.role}
                                        </Badge>
                                    </td>
