                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {data?.ready_to_exam?.length > 0 ? (
                                        ...
                                        <tr>
                                            ...
                                            >
                                                Belum ada antrian pasien untuk
                                                hari ini.
                                            </td>
                                        </tr>
                                    )}
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-[#1565C0] to-[#42A5F5] p-8 rounded-[32px] text-white relative overflow-hidden group shadow-xl shadow-blue-100">
                        ...
                        <p className="text-sm text-white/80 leading-relaxed mb-6 font-medium">
                            Pastikan kualitas gambar fundus optimal (pencahayaan
                            merata) untuk mendapatkan akurasi AI di atas 95%.
                        </p>
                        <button
                            type="button"
                            onClick={() => {
                                window.location.href =
                                    "https://www.apollohospitals.com/id/diagnostics-investigations/fundus-photography";
                            }}
