    ...
    const readyToExam = [
        {
            ...
            name: "Budi Santoso",
            time: "09:15",
            complain: "Mata kabur di malam hari",
            status: "Menunggu",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            name: "Dewi Lestari",
            time: "11:30",
            complain: "Sakit kepala hebat & mual",
            status: "Menunggu",
        },
        {
            id: 5,
    ...
    const pieData =
        selectedResult === "NORMAL"
            ? [
                  ...
                  { name: "Glaukoma", value: 8 },
              ]
            : [
                  { name: "Normal", value: 15 },
                  { name: "Glaukoma", value: 85 },
              ];
                ...
                <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1565C0] to-[#42A5F5] items-center justify-center p-12 text-white relative overflow-hidden">
                    ...
                    <div className="relative text-center max-w-md">
                        ...
                        <p className="text-xl font-light opacity-90 leading-relaxed">
                            Sistem Deteksi Glaukoma Berbasis AI Terintegrasi RS
                            Mata Sejahtera
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                    <div className="max-w-md w-full">
                        ...
                        <p className="text-gray-500 mb-8">
                            Silakan masuk ke akun medis Anda
                        </p>
                        ...
                        <p className="mt-8 text-center text-sm text-gray-400">
                            © 2025 RS Mata Sejahtera IT Division. All rights
                            reserved.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="animate-in fade-in duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                            {dashboardStats.map((stat, i) => (
                                ...
                                >
                                    <div
                                        className={`${stat.color} p-4 rounded-2xl text-white shadow-lg shadow-${stat.color.split("-")[1]}-200`}
                                    >
                                        <stat.icon
                                            size={28}
                                            className={
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gradient-to-br from-[#1565C0] to-[#42A5F5] p-6 rounded-3xl text-white">
                                    ...
                                    <p className="text-sm text-white/80 leading-relaxed mb-4">
                                        Pastikan kualitas gambar fundus optimal
                                        (pencahayaan merata) untuk mendapatkan
                                        akurasi AI di atas 95%.
                                    </p>
                    ...
                    <div className="max-w-4xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="flex items-center justify-between mb-12 relative px-10">
                            ...
                            {[1, 2, 3].map((s) => (
                                ...
                                >
                                    <div
                                        className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-all shadow-lg ${examStep >= s ? "bg-blue-600 text-white scale-110" : "bg-white text-gray-400 border-2 border-gray-200"}`}
                                    >
                                        {examStep > s ? (
                                            <CheckCircle size={24} />
                                        ) : (
                                    ...
                                    <span
                                        className={`text-sm font-semibold ${examStep >= s ? "text-blue-600" : "text-gray-400"}`}
                                    >
                                        {s === 1
                                            ? "Info Pasien"
                                            : s === 2
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                                    ...
                                    <div>
                                        ...
                                        <div className="p-6 bg-blue-50 text-blue-800 rounded-3xl min-h-[160px] italic relative overflow-hidden">
                                            ...
                                            "Mata sering terasa kabur saat malam
                                            hari, terkadang melihat lingkaran
                                            pelangi di sekitar lampu jalan.
                                            Akhir-akhir ini sering sakit kepala
                                            di bagian depan."
                                        </div>
                                        <div className="mt-6 flex items-start gap-3 text-sm text-gray-500 p-4 border border-dashed border-gray-200 rounded-2xl">
                                            ...
                                            darah tinggi (Hipertensi) sejak 2
                                            tahun lalu.
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                {[
                                                    ...
                                                    <button
                                                        key={opt}
                                                        className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${opt === "Kiri" ? "border-blue-600 bg-blue-50 text-blue-600" : "border-gray-100 text-gray-500 hover:border-gray-200"}`}
                                                    >
                                                        {opt}
                                                    </button>
                                                ))}
                                ...
                                {mlLoading ? (
                                    <div className="bg-white p-20 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                                        ...
                                        <p className="text-gray-500 max-w-sm">
                                            Sistem kami sedang memproses
                                            segmentasi cakram optik dan
                                            menghitung perbandingan cup-to-disc.
                                        </p>
                                    </div>
                                ) : (
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex bg-gray-200 p-1 rounded-2xl w-fit mx-auto shadow-inner">
                                            <button
                                                ...
                                                className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${selectedResult === "NORMAL" ? "bg-white shadow-md text-green-600" : "text-gray-500"}`}
                                            >
                                                Demo: NORMAL
                                            </button>
                                            <button
                                                ...
                                                className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${selectedResult === "GLAUKOMA" ? "bg-white shadow-md text-red-600" : "text-gray-500"}`}
                                            >
                                                Demo: GLAUKOMA
                                            </button>
                                        </div>
                                        ...
                                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                                            <div className="flex flex-col md:flex-row gap-8 items-center mb-10">
                                                <div
                                                    className={`p-8 rounded-[40px] flex flex-col items-center justify-center min-w-[240px] shadow-lg shadow-gray-100 border-2 ${selectedResult === "NORMAL" ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"}`}
                                                >
                                                    <p className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">
                                                        Hasil Prediksi AI
                                                    </p>
                                                    <h2
                                                        className={`text-4xl font-black mb-1 ${selectedResult === "NORMAL" ? "text-green-700" : "text-red-700"}`}
                                                    >
                                                        {selectedResult}
                                                    </h2>
                                                    <div
                                                        className={`flex items-center gap-1 font-bold ${selectedResult === "NORMAL" ? "text-green-600" : "text-red-600"}`}
                                                    >
                                                        {selectedResult ===
                                                        "NORMAL" ? (
                                                            <CheckCircle
                                                ...
                                                <div className="flex-1 w-full">
                                                    ...
                                                    <div className="h-4 bg-gray-100 rounded-full overflow-hidden mb-4">
                                                        <div
                                                            className={`h-full transition-all duration-1000 ${selectedResult === "NORMAL" ? "bg-green-500" : "bg-red-500"}`}
                                                            style={{
                                                                width:
                                                                    selectedResult ===
                                                                    "NORMAL"
                    ...
                    <div className="animate-in fade-in duration-500">
                        <div className="flex justify-between items-end mb-8">
                            <div>
                                ...
                                <p className="text-gray-500">
                                    Arsip data medis dan hasil AI sebelumnya
                                </p>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                                ...
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-gray-50">
                                        {historyData.map((data, i) => (
                                            ...
                                            >
                                                <td className="px-6 py-4 text-center text-gray-400 text-sm font-bold">
                                                    {i + 1}
                                                </td>
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span
                                                        className={`px-3 py-1 rounded-full text-[10px] font-black tracking-widest ${data.result === "NORMAL" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                                                    >
                                                        {data.result}
                                                    </span>
                                                </td>
                            ...
                            <div className="p-6 bg-gray-50 border-t border-gray-100 flex justify-between items-center">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        className="p-2 border border-gray-200 rounded-lg hover:bg-white text-gray-400 disabled:opacity-50"
                                        disabled
                                    >
                                        <ChevronRight
                                            size={18}
                                    ...
                                    <button className="px-3 py-1 bg-blue-600 text-white rounded-lg text-sm font-bold">
                                        1
                                    </button>
                                    <button className="px-3 py-1 hover:bg-white border border-transparent hover:border-gray-200 rounded-lg text-sm text-gray-600">
                                        2
                                    </button>
                                    <button className="px-3 py-1 hover:bg-white border border-transparent hover:border-gray-200 rounded-lg text-sm text-gray-600">
                                        3
                            ...
                            <div className="p-8 border-b border-gray-100 flex justify-between items-center">
                                <div>
                                    <p className="text-xs font-black text-blue-600 uppercase tracking-widest mb-1">
                                        Arsip Medis #{selectedHistory.id}
                                    </p>
                                    ...
                                    <div className="lg:col-span-2 space-y-8">
                                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                                            ...
                                            <div className="flex gap-6 items-center">
                                                <div
                                                    className={`p-6 rounded-2xl flex flex-col items-center justify-center min-w-[160px] ${selectedHistory.result === "NORMAL" ? "bg-green-50 text-green-700 border border-green-100" : "bg-red-50 text-red-700 border border-red-100"}`}
                                                >
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                                                        <div
                                                            className={`h-full ${selectedHistory.result === "NORMAL" ? "bg-green-500" : "bg-red-500"}`}
                                                            style={{
                                                                width: `${selectedHistory.conf}%`,
                                                            }}
                                                        ></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                                            ...
                                            <div className="p-5 bg-blue-50/50 border border-blue-100 rounded-2xl text-blue-900 italic text-sm leading-relaxed">
                                                "Berdasarkan analisis AI dan
                                                pemeriksaan fisik, struktur
                                                saraf mata masih dalam batas
                                                normal. Namun, terdapat riwayat
                                                keluarga glaukoma. Disarankan
                                                kontrol rutin 6 bulan sekali dan
